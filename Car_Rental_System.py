...
def CarRent():
    try:
        ...
        def service(n,s):
            db = TinyDB("Path of your json file")
            user = Query()
            ...
            if s == 1:
                ...
                if Path("Path of text file where you have list of cars available to rent").stat().st_size == 0:
        ...
        def Pay(car,find, n):  
            if car in find:
                ...
                close = str(get_close_matches(car,l))
